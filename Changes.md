...
- Box :
  ...
  - Added "Set Default Values" item to NodeEditor tool menu. This sets the default values for all plugs from their current values.
  - Added "Set Default Value" item to plug context menu. This sets the default value from the current value.
