...
- PlugLayout : Added support for `<layoutName>:autoRevealThreshold` to control the maximum number of visible plugs that will cause sections to be automatically expanded. Defaults to 0, which disables autoexpansion.
